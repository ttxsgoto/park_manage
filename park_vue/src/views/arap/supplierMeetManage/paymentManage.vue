...
<template>
    <div>
                            ...
                            <el-row :gutter="10">
                                <el-col :span="8">
                                    <el-form-item label="付款日期:">
                                        <el-date-picker v-model="payerTime" type="daterange" @change="startSearch"
        ...
        <pay-manage-dialog :arap-dialog="arapDialog" v-on:closeDialogBtn="closeDialog"
                           :arap-row="arapRow"></pay-manage-dialog>
    </div>
</template>
<script>
    import payManageDialog from '@/components/arap/payManageDialog';

    export default {
        name: 'paymentManage',
        components: {
            payManageDialog: payManageDialog
        },
        computed: {},
        data() {
            return {
