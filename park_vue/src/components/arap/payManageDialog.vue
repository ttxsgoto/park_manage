...
<template>
    <div>
        <el-dialog :title="title" :visible.sync="arapDialog.isShow" width="30%" center :before-close="closeBtn"
            ...
            adjustBtn: function () {
                ...
                this.$refs['formRules'].validate((valid) => {
                    if (valid) {
                        ...
                        let apiName = 'addSupplierPay';
                        if (this.arapDialog.type === 'update') {
                            postData.id = this.arapRow.id;
                            apiName = 'updateSupplierPay';
                        } else {
                            apiName = 'addSupplierPay';
                        }
